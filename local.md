Make sure to install all dependencies for torchserve

https://github.com/pytorch/serve/tree/master

Also java version needs to be greater than equal to java 11
